...
A Relational Database is a model whereas SQL is a language used to query said database.

1. Why do tables need a `primary key`?

It is used to uniquely identy a row.
...
An intermediary table that gives us two one to many relationship.
